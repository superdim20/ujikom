                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group dropend">
                        ...
                        <li>
                          <a href="{{ route('user.edit', $data->id) }}" class="dropdown-item text-warning">
                            <i class="bx bx-edit-alt me-2"></i> Edit
                          </a>
                        </li>
                        <li>
                          <!-- Form delete dengan tombol submit tersembunyi -->
                          <form action="{{ route('user.destroy', $data->id) }}" method="POST" id="delete-form-{{ $data->id }}">
                            @csrf
                            @method('DELETE')
