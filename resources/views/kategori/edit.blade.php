          ...
          <div class="col-xl">
            <div class="card mb-4">
              ...
              <form action="{{ route('kategori.update', $kategori->id) }}" method="POST"
                        ...
                        @csrf
                  <div class="mb-3">
                    <label class="form-label" for="basic-icon-default-nama_kategori">kategori Name</label>
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text">
                        <i class="bx bx-user"></i>
                      </span>
                      <input type="text" name="nama_kategori" class="form-control @error('nama_kategori') is-invalid @enderror" id="basic-icon-default-nama_kategori" placeholder="kategori Name" aria-describedby="basic-icon-default-fullname2" 
