              ...
              <form action="{{ route('publisher.update', $publisher->id) }}" method="POST"
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" name="nama_publisher" class="form-control @error('nama_publisher') is-invalid @enderror" id="basic-icon-default-nama_publisher" placeholder="Publisher Name" aria-describedby="basic-icon-default-fullname2" 
                      value="{{ $publisher->nama_publisher }}"/>
                    </div>
                  </div>
